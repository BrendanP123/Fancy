...
public class GlowBrickRender implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer)
    {
        ...
        RenderUtil.instance().drawFaces(renderer, block, ((BlockFancy) block).textureBackground, true);
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer)
    {
        ...
        t.setBrightness(255);
        RenderUtil.instance().renderAllSides(world, x, y, z, block, renderer, ((BlockFancy) block).textureBackground, true);
